...
addDicField('frtchgitm:10:Charge Item');
...
addDicField('agtnum:5:Agent Code');
...
addDicField('bilno:25:B/L Number');
addDicField('bilnum:25:B/L Number');
...
addDicField('brth:2,0:Berth');
addDicField('cargpno:13,0:car Gate Pass Number');
...
addDicField('chgitmrte:10,4:Charge Rate');
...
addDicField('chgprfusg:3:Charge Profile Usage');
...
addDicField('cnsacc:5:Customer Code');
...
addDicField('concde:5:Customer Code');
...
addDicField('decprecision:9,0:decprecision');
addDicField('rangetype:2:rangetype');
...
addDicField('descr:1000:Description');
...
addDicField('dscreason:40:Discount Reason');
...
addDicField('exmpcsn:5:Customer');
...
addDicField('gatepsno:13,0:Gate Pass Number');
...
addDicField('invcgaddtl:80:Additional Detail');
...
addDicField('invnbr:13,0:Invoice Number');
addDicField('invpdto:date:Paid To');
addDicField('invref:13,0:Reference');
addDicField('invsts:1:Status');
...
addDicField('lcdnno:13,0:Last Credit Note Number');
...
addDicField('lgpno:13,0:Last Gatepass Number');
...
addDicField('linvno:13,0:Last Invoice Number');
...
addDicField('lrcpno:13,0:Last Receipt Number');
addDicField('lldgno:13,0:Last Lodgement Number');
addDicField('lrfnno:13,0:Last Refund Number');
addDicField('lordfrmid:13,0:Last Order Form Number');
addDicField('marks:150:Markings');
...
addDicField('ntfyacc:5:Notify Code');
...
addDicField('paymnt:1:Payment Made');
...
addDicField('rcpcgaddtl:80:Additional Detail');
...
addDicField('rcpinvnbr:13,0:Invoice Number');
addDicField('rcpitm:10:Item');
addDicField('rcpnbr:13,0:Receipt Number');
...
addDicField('rcppylcsn:5:Lodgement Customer Code');
...
addDicField('ship:10:Ship');
addDicField('shipper:40:Shipper Name');
addDicField('shpacc:5:Shipper Code');
addDicField('shpadd:200:Shipper Address');
addDicField('shpnam:30:Vessel');
addDicField('shpnum:10:Ship');
...
addDicField('systab:10:System Table');
...
addDicField('wsascon:5:Customer');
addDicField('wsascur:3:Currency');
addDicField('wsasdesc:40:Description');
addDicField('wsasinvno:13,0:Invoice Number');
...
addDicField('cdninvnbr:13,0:Invoice Number');
addDicField('cdnitm:10:Item');
addDicField('cdnnbr:13,0:Credit Note Number');
...
addDicField('rfnrcpnbr:13,0:Receipt Number');
addDicField('rfnnbr:13,0:Refund Number');
...
addDicField('wsldgnbr:13,0:Transaction Number');
...
addDicField('wsldgrcp:13,0:Receipt Number');
...
addDicField('typenbr:13,0:Type Number');
...
addDicField('wharfage:13,2:Wharfage');

addDicField('ordformnbr:13,0:Order Form Number');
addDicField('ordformsts:1:Order Form Status');
addDicField('ordformdat:date:Order Form Date');
addDicField('ordformtim:time:Order Form Time');
addDicField('wharfcode:10:Wharfinger Code');
addDicField('ordcust:10:Order Customer Code');
addDicField('ordcustname:79:Order Customer Name');
addDicField('ordcustadd1:40:Address 1');
addDicField('ordcustadd2:40:Address 2');
addDicField('ordcustadd3:40:Address 3');
addDicField('contnum:11:Container Number');
addDicField('contsize:2,0:Container Size');
addDicField('wharfdesc:50:Wharfinger');
addDicField('ordfcdate:date:Cancelled Date');
addDicField('ordfctime:time:Cancelled Time');
addDicField('ordfcusr:10:Cancelled By');
addDicField('ordfcrsn:60:Reason');
addDicField('ashpnam:30:Arrival Ship Name');
addDicField('avgeno:10:Arrival Voyage Number');
addDicField('aarrdate:date:Arrival Date');


//**********Job Costing

addDicField('actcmt:150:Comment');
addDicField('actcur:3:Activity Currency');
addDicField('actid:9,0:Activity ID');
addDicField('actdesc:30:Description');
addDicField('actsts:1:Status');
addDicField('arrplace:100:arrplace');
addDicField('asgndelvdate:date:Date Assigned');
addDicField('address1:50:Address 1');
addDicField('address2:50:Address 2');
addDicField('address3:50:Address 3');
addDicField('bilparty:1:Bill Party');
addDicField('biltonam:100:Bill To');
addDicField('biltoadd:200:Bill To Address');
addDicField('bodytype:30:Body Type');
addDicField('cassisnum:30:Cassis Num');
addDicField('chgsrc:1:chgsrc');
addDicField('cost:9,0:Cost');
addDicField('datedelv:date:Date Delivered');
addDicField('depreq:1:Deposit Required?');
addDicField('delrcvby:30:Received By');
addDicField('delreq:1:Delivery Required?');
addDicField('drlicence:15:Drivers Licence');
addDicField('estenddate:date:Estimated End Date');
addDicField('estendtime:time:Estimated End Time');
addDicField('estimate:9,0:Estimate');
addDicField('expdate:date:Expiry Date');
addDicField('fitexpdate:date:Fitness Expiry');
addDicField('fname:30:First Name');
addDicField('insurexpdate:date:Insurance Expiry');
addDicField('jobid:9,0:Job ID');
addDicField('jobdesc:35:Job Description');
addDicField('jobsts:1:Status');
addDicField('licencetype:15:Licence Type');
addDicField('make:15:Make');
addDicField('makeid:9,0:makeid');
addDicField('makeyear:9,0:Make-Year');
addDicField('model:50:Model');
addDicField('mname:30:Middle Name');
addDicField('platenum:10:Plate Num');
addDicField('qtcur:3:Quote Currency');
addDicField('qtdate:date:Quote Date');
addDicField('qtnum:9,0:Quote Number');
addDicField('qtsts:1:Quote Status');
addDicField('qttotal:9,0:Quote total');
addDicField('qtusr:10:User');
addDicField('recpid:10:ID No.');
addDicField('recpidtype:15:ID Type');
addDicField('recpidexp:date:ID Expiry Date');
addDicField('regexpdate:date:Registration Expiry');
addDicField('sname:30:Last Name');
addDicField('truckcmpy:10:Delivery Company');
addDicField('truckext:1:Trucker Type');
addDicField('typeid:9,0:typeid');
addDicField('vehreg:6:Registration No.');
addDicField('vehdriver:11:Driver Licence');

//Charge item additions
...
//Customer type
addDicField('custypdsc:30:Type Description');
...
$dt=new dbTableDef("wsordform");
$dt.desc="Order Form";
$dt.field="ordformnbr,iocode,ordformsts,ordformdat,ordformtim,wharfcode,ordcust,ordcustname,ordcustadd1,ordcustadd2,ordcustadd3,contnum,contsize,ship,shpnam,vgeno,arrdate,portld,portdc,weight,unitwgt,mesur,unitmsr,descr,marks,bilno,bilref,addedby,cnttpdsc,ashpnam,avgeno,aarrdate";
$dt.keyfield="ordformnbr";
$dt.index[0]="byimpexp:iocode,ordformnbr";
applyDbTableDef($dt);

$dt=new dbTableDef("wsordformcan");
$dt.desc="Cancelled Order Form";
$dt.field="ordformnbr,ordfcdate,ordfctime,ordfcusr,ordfcrsn"
$dt.keyfield="ordformnbr";
applyDbTableDef($dt);

$dt=new dbTableDef("wswharf");
$dt.desc="Wharf";
$dt.field="wharfcode,wharfdesc";
$dt.keyfield="wharfcode";
applyDbTableDef($dt); 
...
$dt.field="ordnbr,trandate,trantime,tranuser,connum,voyref,cnsign,cnsadd,bilref";
$dt.keyfield="ordnbr";
...
$dt.desc="Menu User"
$dt.field="usrid,usrpwd,usrnmf,usrnml,usrlvl,usrsts,usrgrpprf,usrpwexp"
$dt.keyfield="usrid";
applyDbTableDef($dt);
...
$dt.field="bilref,bilcgitm,bilcgamt,bilcgcur,bilpaytyp,blcgquan"
$dt.keyfield="bilref,bilcgitm";
applyDbTableDef($dt);

$dt=new dbTableDef("WSBLCON")
$dt.desc="B/L Container File"
$dt.field="refno,refcod,connum,efcod,conloc,concomm"
$dt.keyfield="refno,connum";
applyDbTableDef($dt);

$dt=new dbTableDef("WSBLDETL")
$dt.desc="Bill Of Lading Details"
$dt.field="bilref,dtlnbr,descr,pkgcde,weight,mesur,quan,quan1,marks,comcde,unitwgt,unitmsr,loctn,chgitm1,chgitm2,chgitm3,chgitm4,chgitm5"
...
$dt.field="ietype,dttype,voyref,bilno,itemno,porto,portld,portdc,portd,cnsacc,cnsign,cnsadd,shpacc,shipper,shpadd,ntfyacc,notify,ntfyadd,bilref,bilrefm,bilgrppro,rtcde,wftxcd,reqaprvl,atuser,atdate,attime,atcode,vluser,vldate,vltime,vlcode,hruser,hrdate,hrtime,hrcode,paymnt,gtpass,blcur,bilpsts"
$dt.keyfield="voyref,bilno,itemno";
$dt.index[0]="wsblhdprf:bilgrppro";
$dt.index[1]="wsblhdref:bilref";
$dt.index[2]="wsblhdrefm:bilrefm";
$dt.index[3]="wsblhdvoy:voyref";
$dt.index[4]="wsblhdcsn:cnsign,voyref";
$dt.view[0]="wsblhdpg:*:paymnt='Y' and gtpass<>'Y':";
$dt.view[1]="wsblhdrqa:*:reqaprvl='Y' and atcode<>'A':";

//$dt.view[2]="wsblhdcsn2:DISTINCT cnsign:";
applyDbTableDef($dt);

$dt=new dbTableDef("WSBLVEH")
$dt.desc="B/L Motor Vehicle file"
$dt.field="refno,carsnum,cartype,caryear,carloc,cargpno"
...
$dt.keyfield="chgitem"
$dt.field="chgitem,chgdesc,longdesc,chgdbtac,chgcdtac,sysitm,depitem,depchgitem,billinggrp";
applyDbTableDef($dt);
...
$dt.field="chgprfcde,chgitem,chgprfdl,chgprtabl,chgapprte,chgfdates,chgtdates,chgfdatad,chgtdatad,exchlydayf,exchlydayt"
...
$dt.field="connum,size,type"
$dt.keyfield="connum";
applyDbTableDef($dt);

$dt=new dbTableDef("WSCONSGN")
$dt.desc="Customer Master"
$dt.field="concde,connam,conadd,conadd2,conadd3,conadd4,conadd5,conemail,conemldoc,conphno,confax,concontac,concdtlm,concdtob,exmptint,custype,constatus,confname,conlname,intcycle,trn"
$dt.keyfield="concde";
applyDbTableDef($dt);
...
$dt.field="currcode,currate,cureffdt"
...
$dt.field="gpno,gpref,gpuser,gpdate,gptime,gprundate,gpruntime,gpcustrl,gpplate,gphauler,gpdriver,gpdevclk,gpgateoff,gpexit,gpstatus,gptype,gpcmt,ordnbr,gpdriverid,gpcstmdlv"
$dt.keyfield="gpno";
...
$dt.field="invnbr,invitm,invref,invcgamt,invcuramt,invdcamt,invcurdca,invpdto,invcon,invcgamtlcy,invcgaddtl,ordnbr,linenbr,actid"
$dt.keyfield="invnbr,invref,invitm,invcon";
$dt.index[0]="wsinvdtl1:invitm";
$dt.index[1]="wsinvdtl2:invref";
$dt.index[2]="wsinvdtl3:ordnbr";
$dt.index[3]="wsinvdtl4:actid";
$dt.view[0]="wsinvhddl:WSINVDETL.INVNBR, WSINVHEAD.INVDATE, WSINVHEAD.INVTIME, WSINVHEAD.INVAMT, WSINVHEAD.INVCUR, WSINVHEAD.INVSTS, WSINVDETL.INVITM, WSINVDETL.INVREF, WSINVHEAD.INVAMTPD, WSINVDETL.INVCGAMT, WSINVDETL.INVCURAMT, WSINVDETL.INVDCAMT, WSINVDETL.INVCURDCA, WSINVDETL.INVPDTO, WSINVDETL.INVCON, ordnbr,wsinvdetl.ACTID:WSINVDETL.INVNBR=WSINVHEAD.INVNBR:WSINVHEAD:";
...
$dt.field="invnbr,invsts,invdate,invtime,invamt,invamtpd,invamtdc,invcur,invcust,invusr,invtype,invamtlcy,remarks"
$dt.keyfield="invnbr";
...
$dt.field="rcpnbr,rcpitm,rcpref,rcpcgamt,rcpcuramt,rcpdcamt,rcpcurdca,rcpcon,rcppdto,rcpinvnbr,rcpcgamtlcy,rcpcgaddtl,ordnbr,linenbr,actid"
...
$dt.field="rcpnbr,rcpsts,rcpdate,rcptime,rcpamt,rcpamtdc,rcpcur,rcpusr,rcrcvby,rcpamtlcy,cnsadd"
$dt.keyfield="rcpnbr";
...
$dt.desc="Ship File"
$dt.field="shpnum,shpnam,shptype,maxgrt,maxnrt,length,drght,beam,vesopr,regist,confrc,stpcod,bowtrs,vesrgt,imocde,loadtype"
$dt.keyfield="shpnum";
applyDbTableDef($dt);

$dt=new dbTableDef("WSSHPRPT")
$dt.desc="Ship Report File"
$dt.field="ship,vgeno,arrdate,arrtime,depdate,deptim,strdate,strtim,stpdate,brth,duedate,duetim,portl,portn,stgdate,agtnum,water,passenger,pltpenper,crsdisper,pltname,linenbr,voyptr,iocode,dsempassr,styovpassr,nvispassr"
$dt.keyfield="ship,arrdate,vgeno";
$dt.index[0]="wsshprptl:voyptr";
$dt.index[1]="wsshprptd:arrdate";
$dt.view[0] ="wsblhdshrt:ship,vgeno,arrdate,arrtime,depdate,deptim,strdate,strtim,stpdate,brth,duedate,duetim,portl,portn,stgdate,agtnum,water,passenger,pltpenper,crsdisper,pltname,linenbr,voyptr,ietype,dttype,voyref,bilno,itemno,porto,portld,portdc,portd,cnsacc,cnsign,cnsadd,bilref,bilrefm,bilgrppro,rtcde,wftxcd,reqaprvl,atuser,atdate,attime,atcode,vluser,vldate,vltime,vlcode,hruser,hrdate,hrtime,hrcode,paymnt,gtpass:voyref=voyptr:wsblhead"
applyDbTableDef($dt);

$dt=new dbTableDef("WSSYSPRM")
$dt.desc="System Parameters"
$dt.field="cmpname,cmpaddr1,cmpaddr2,cmpaddr3,cmpaddr4,cmpaddr5,cmptele,cmpfax,cmpemail,cmpcontact,lrcpno,linvno,lgpno,rcpvarnce,datefmt,timefmt,lcdnno,blholddft,useblval,useblapv,invexrtdt,lldgno,lrfnno,lordfrmid";
$dt.keyfield="";
applyDbTableDef($dt);

$dt=new dbTableDef("WSTMPBL")
$dt.desc="EDI Temporary BL File"
$dt.field="tranmisid,bilnum,itemno,masterbl,ietype,dttype,porto,portld,portdc,portd,cnsacc,cnsign,cnsadd,shpacc,shipper,shpadd,ntfyacc,notify,ntfyadd,bilgrppro,reqaprvl,transfer,trfuser,trfdate,trftime"
...
$dt.field="tranmisid,bilnum,dtlnbr,descr,pkgcde,weight,mesur,quan,marks,comcde,unitwgt,unitmsr,loctn,chgitm1,chgitm2,chgitm3,chgitm4,chgitm5"
...
$dt.field="tranmisid,bilnum,carsnum,cartype,caryear,carloc"
...
$dt.field="voyref,connum,gateout,gatepsno,gatein,gateintm,gateinby,demstart,detstart,dprtdate,tobeshpd,strduedat,seal1,seal2,seal3,seal4,seal5,driver,license,contsts,dttype,strpdate,strptime,strpby,stufdate,stuftime,stufby,stuford,wharfage"
...
$dt.field="cdnnbr,cdnsts,cdninvnbr,cdndate,cdntime,cdnamt,cdncur,cdncust,cdnusr,cdnamtlcy,cdncmt";
$dt.keyfield="cdnnbr";
...
$dt.field="rfnnbr,rfnitm,rfnref,rfncgamt,rfncon,rfncgamtlcy,linenbr,rfncgcura,actid"
...
$dt=new dbTableDef("Drivers");
$dt.desc="Drivers";
$dt.keyfield="drlicence"
$dt.field="fname,mname,sname,drlicence,expdate,licencetype,address1,address2,address3";
applyDbTableDef($dt);

$dt=new dbTableDef("MotorBodyType");
$dt.desc="MotorBodyType";
$dt.index[0]="index1:typeid"
$dt.keyfield="typeid"
$dt.field="bodytype,typeid";
applyDbTableDef($dt);

$dt=new dbTableDef("MotorMake");
$dt.desc="MotorMake";
$dt.index[0]="index1:makeid"
$dt.keyfield="makeid"
$dt.field="make,makeid";
applyDbTableDef($dt);

$dt=new dbTableDef("MotorVehicle");
$dt.desc="MotorVehicle";
$dt.keyfield="platenum"
$dt.field="make,makeyear,platenum,cassisnum,insurexpdate,fitexpdate,regexpdate,bodytype,model";
applyDbTableDef($dt);

$dt=new dbTableDef("wscustyp");
$dt.desc="wscustyp";
$dt.keyfield="custype"
$dt.field="custype,custypdsc";
applyDbTableDef($dt);

$dt=new dbTableDef("wsjob");
$dt.desc="wsjob";
$dt.keyfield="jobid"
$dt.field="jobid,bilno,cnsign,cnsadd,shipper,shpadd,notify,ntfyadd,bilparty,biltonam,biltoadd,shpnum,arrdate,arrtime,arrplace,jobsts,cnsacc,shpacc,ntfyacc,portd,jobdesc";
applyDbTableDef($dt);

$dt=new dbTableDef("WSJOBACT");
$dt.desc="WSJOBACT";
$dt.keyfield="jobid, actid"
$dt.field="jobid,actid,actcur,actdesc,chgprfgrp,qtnum,actsts,strdate,enddate,strtime,endtime,actcmt,delreq,vehreg,vehdriver,truckcmpy,truckext,asgndelvdate,delrcvby,recpid,recpidtype,recpidexp,datedelv,depreq,estenddate,estendtime";
applyDbTableDef($dt);

$dt=new dbTableDef("WSJOBACTDETLS");
$dt.desc="WSJOBACTDETLS";
$dt.keyfield="jobid, actid, chgitem"
$dt.field="jobid,actid,chgitem,chgitmcur,chgsrc,estimate,cost";
applyDbTableDef($dt);

$dt=new dbTableDef("wsjobitmcnas");
$dt.desc="wsjobitmcnas";
$dt.field="jobid,dtlnbr,connum";
applyDbTableDef($dt);

$dt=new dbTableDef("wsjobitmdetl");
$dt.desc="wsjobitmdetl";
$dt.keyfield="jobid, dtlnbr"
$dt.field="jobid,dtlnbr,descr,pkgcde,weight,mesur,quan,quan1,marks,comcde,unitwgt,unitmsr,loctn,chgitm1,chgitm2,chgitm3,chgitm4,chgitm5";
applyDbTableDef($dt);

$dt=new dbTableDef("wsquotdtl");
$dt.desc="wsquotdtl";
$dt.index[0]="index1:jobid"
$dt.keyfield="qtnum,jobid,actid,chgitem"
$dt.field="qtnum,jobid,actid,chgitem";
applyDbTableDef($dt);

$dt=new dbTableDef("wsquothdr");
$dt.desc="wsquothdr";
$dt.keyfield="qtnum";
$dt.field="qtnum,qtdate,jobid,qtsts,qtusr,qttotal,qtcur";
applyDbTableDef($dt);
...
applyDbTableDef($dt);
// End Request for Approval Files
